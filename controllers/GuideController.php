    ...
    public function createGuide()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($err)) {
                ...
                if (!empty($_FILES['guide_images']['name'])) {
    $this->guideQuery->avt = upload_file('image/GuideImages', $_FILES["guide_images"]);
} else {
    $this->guideQuery->avt = null;
}

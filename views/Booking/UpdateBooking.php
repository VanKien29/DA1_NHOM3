        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <select name="tour_id" class="form-select">
                    ...
                    <option value="<?= $t['tour_id'] ?>"
                        <?= (($booking['tour_id'] ?? '') == $t['tour_id']) ? 'selected' : '' ?>>
                        <?= $t['tour_name'] ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-select">
                    <option value="cho_duyet" <?= ($booking['status'] == 'cho_duyet') ? 'selected' : '' ?>>Chờ duyệt
                    </option>
                    <option value="dang_dien_ra" <?= ($booking['status'] == 'dang_dien_ra') ? 'selected' : '' ?>>Đang
                        diễn ra</option>
                    <option value="da_hoan_thanh" <?= ($booking['status'] == 'da_hoan_thanh') ? 'selected' : '' ?>>Đã
                        hoàn thành</option>
            ...
            <div class="form-group">
                ...
                <select name="hotel_id" class="form-select">
                    ...
                    <option value="<?= $h['hotel_service_id'] ?>"
                        <?= (($booking['hotel_id'] ?? '') == $h['hotel_service_id']) ? 'selected' : '' ?>>
                        <?= $h['service_name'] ?>
                    </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="card card-full">
            ...
            <div class="form-group">
                ...
                <select name="customers[]" multiple class="form-select multi">
                    ...
                    <option value="<?= $c['customer_id'] ?>"
                        <?= in_array($c['customer_id'], $selectedCustomers) ? 'selected' : '' ?>>
                        <?= $c['full_name'] ?> - <?= $c['phone'] ?>
                    </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="main_customer" class="form-select">
                    ...
                    <?php foreach ($customers as $c): ?>
                    <option value="<?= $c['customer_id'] ?>"
                        <?= (($main_customer_old ?? '') == $c['customer_id']) ? 'selected' : '' ?>>
                        <?= $c['full_name'] ?> - <?= $c['phone'] ?>
                    </option>
                    <?php endforeach; ?>
                </select>

...
<div class="admin-list-container">
    <div class="admin-list-title">Thêm Tour Mới</div>

    <form method="POST" action="">
        <div class="form-group">
            <label for="tour_name">Tên Tour</label>
            <input type="text" id="tour_name" name="tour_name" class="form-control" required>
        </div>
        ...
        <div class="form-action">
            <button type="submit" class="btn-add text-white text-decoration-none">Thêm Tour</button>
